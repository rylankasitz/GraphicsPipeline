...
class ShaderOneInterface {
	...
	CGparameter fragmentHasTexture;
	CGparameter fragmentLight;
	CGparameter fragmentFloor;
	CGparameter fragmentBox1;
	CGparameter fragmentBox2;
	CGparameter fragmentBox3;
	CGparameter fragmentBox1t;
	CGparameter fragmentBox2t;
	CGparameter fragmentBox3t;
public:
	Scene* scene;
	TMesh* currentMesh;

	ShaderOneInterface(Scene* scene) { this->scene = scene; };
